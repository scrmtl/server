...
SESSION_COOKIE_PATH = os.getenv('OVERWRITEWEBROOT')
LOGIN_REDIRECT_URL= os.getenv('OVERWRITEWEBROOT')
LOGOUT_REDIRECT_URL= os.getenv('OVERWRITEWEBROOT')
STATIC_FILES_URL= (os.getenv('OVERWRITEWEBROOT') + 'static/')
MEDIA_FILES_URL= (os.getenv('OVERWRITEWEBROOT') + 'media/')
      ...
      <v-row align="center">
        ...
        <v-col>
          <v-text-field
            ...
            outlined
            dense
            :value="projectInformation.start"
          ></v-text-field>
        </v-col>
        <!-- Project end -->
        <v-col>
      ...
      <v-row align="center">
        <v-col>
          <v-text-field
            ...
            outlined
            dense
            :value="projectInformation.sprint_duration"
          ></v-text-field>
        </v-col>
      </v-row>
      <!-- Projectdiscription -->

    ...
    <v-row>
      <div class="projectBtn">
        <div class="my-2">
          ...
          >
            <template v-slot:activator="{ on, attrs }">
              ...
              v-bind="attrs"
              v-on="on"
              ><v-icon class="mr-1">mdi-folder-plus</v-icon>Projekt erstellen</v-btn>
            </template>
        ...
        <v-card-actions>
          ...
          <v-btn text large color="link"><v-icon class="mr-1">mdi-delete-forever</v-icon>Projekt(e) löschen</v-btn>
        </div>
      </div>
    </v-row>
    <v-row>
